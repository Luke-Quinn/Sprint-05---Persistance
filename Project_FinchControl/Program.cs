    ...
    class Program
    {
       ...
       /// <returns>sensors</returns>
        ...
        static void DisplayRegisterUser()
        {
            ...
            Console.Write("\tEnter your registed user name:");
            ...
            Console.WriteLine();
            Console.WriteLine("\tYou entered the following info and it has be saved.");
            Console.WriteLine($"\tUser name: {userName}");
            Console.WriteLine($"\tPassword: {password}");

            Console.WriteLine();
            Console.WriteLine("\tYou can now proceed to login!");
        ...
        static List<(string userName, string password)> ReadLoginInfoData()
        {
            ...
            //
            // Split method to separate the user name and password into an aarray
            //
